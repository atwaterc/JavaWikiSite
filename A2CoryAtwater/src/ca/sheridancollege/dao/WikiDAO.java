...
public class WikiDAO implements DAO {
	...
	//Populate method to fill database at bottom of code, due to volume of Wiki information.
	...
	//find similar wikis to display in dropdown list on viewWiki.jsp
	...
	public void Populate() {
		...
		Wiki w1 = new Wiki("Alexander Ovechkin", "Sports",
		...
		Wiki w3 = new Wiki("Wayne Gretzky", "Sports",
		...
		Wiki w4 = new Wiki("World War II", "History",
				"World War II (often abbreviated to WWII or WW2), also known as the Second World War, was a global war that lasted from 1939 to 1945. The vast majority of the world's countries—including all the great powers—eventually formed two opposing military alliances: the Allies and the Axis. A state of total war emerged, directly involving more than 100 million people from over 30 countries. The major participants threw their entire economic, industrial, and scientific capabilities behind the war effort, blurring the distinction between civilian and military resources. World War II was the deadliest conflict in human history, marked by 50 to 85 million fatalities, most of whom were civilians in the Soviet Union and China. It included massacres, the genocide of the Holocaust, strategic bombing, premeditated death from starvation and disease, and the only use of nuclear weapons in war.[1][2][3][4]\r\n"
						+ "\r\n"
						+ "Japan, which aimed to dominate Asia and the Pacific, was at war with China by 1937,[5][b] though neither side had declared war on the other. World War II is generally said to have begun on 1 September 1939,[6] with the invasion of Poland by Germany and subsequent declarations of war on Germany by France and the United Kingdom. From late 1939 to early 1941, in a series of campaigns and treaties, Germany conquered or controlled much of continental Europe, and formed the Axis alliance with Italy and Japan. Under the Molotov–Ribbentrop Pact of August 1939, Germany and the Soviet Union partitioned and annexed territories of their European neighbours, Poland, Finland, Romania and the Baltic states. Following the onset of campaigns in North Africa and East Africa, and the fall of France in mid 1940, the war continued primarily between the European Axis powers and the British Empire. War in the Balkans, the aerial Battle of Britain, the Blitz, and the long Battle of the Atlantic followed",
				"/images/ww2.jpg");
		Wiki w5 = new Wiki("Daddy Yankee", "Music",
		...
		Wiki w7 = new Wiki("War of 1812", "History",
				...
				"/images/war-1812.jpg");
		Wiki w8 = new Wiki("Ariana Grande", "Music",
				"Ariana Grande-Butera (born June 26, 1993)[2] is an American singer, songwriter and actress. After starring in the 2008 Broadway musical 13, she rose to prominence for her portrayal of Cat Valentine on the Nickelodeon television series Victorious (2010-13), and its spinoff Sam & Cat (2014-15). Grande made her first musical appearance on the soundtrack for Victorious and was signed to Republic Records in 2011 after music executive Monte Lipman came across one of her YouTube videos covering songs.\r\n"
						+ "\r\n"
				...
				"/images/ariana-grande.jpg");
		Wiki w9 = new Wiki("Kotlin", "Technology",
